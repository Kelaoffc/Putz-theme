...
|_|              
                 "
echo -e "\033[31m"
echo -e "\033[32mWHATSAPP : 083195473404\033[0m"
echo -e "\033[31mWEBSITE : https://t.me/Ellsos"
echo ""

animate_text "ANDA SUDAH TERVERIFIKASI, SILAHKAN MASUKAN LICENSE YANG DI BAGI DARI putz"
animate_text "JIKA BELUM PUNYA LICENSE SILAHKAN BELI DI putz, UNTUK HARGA 25K FREE UPDATE LICENSE"
animate_text " CONTACT putz: "
echo -e "${RED}WHATSAPP: 083195473404${NC}"
echo -e "${RED}WEBSITE : https://t.me/Ellsos${NC}"
echo -e "${GREEN}"
...
# Menampilkan opsi tanpa animasi
  ...
  echo -e "${BLUE}[+]            ©COPYRIGHT BY https://t.me/Ellsos      [+]${NC}"
  echo -e "${BLUE}[+]                                                [+]${NC}"
  echo -e "${BLUE}[+] ============================================== [+]${NC}"
echo ""
 echo -e "${BLUE}[+] ============================================== [+]${NC}"
